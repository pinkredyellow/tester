	...
	function hz6d_cus_web_msg_open(){
		var openurl = "http://www10.53kf.com/webCompany.php?arg=9005540&style=2&kflist=off&kf=&zdkf_type=1&lnk_overflow=0&language=cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fjxt.yuancheng05.com%2Fah%2F910b9430ebc9ea3c%2F&keyword=http%3A%2F%2Fjxt.yuancheng05.com%2F&brief=&logo=&question=&uid=a2e1d28c2761734a4d7cef761545fee0";
		try{
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			if ((pc_ivt_type == '2' || pc_ivt_type == '-1') && 0 == '0') {
			    		...
			    		Inv.prototype = {
			    			...
			    			talk : function(){
			    				...
			    				if (zdfq_type == 3) {
			    					...
			    					var openurl = "http://www10.53kf.com/webCompany.php?arg=9005540&style=2&kflist=off&kf=&zdkf_type=1&lnk_overflow=0&language=cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fjxt.yuancheng05.com%2Fah%2F910b9430ebc9ea3c%2F&keyword=http%3A%2F%2Fjxt.yuancheng05.com%2F&brief=&logo=&question=&uid=a2e1d28c2761734a4d7cef761545fee0&tfrom=2" + force_kf;
			    					onliner_zdfq=2;
				...
				tmp_innerHTML += '<div id="iframe_company_mini_div" style="'+mini_div_display+'font-size: 0;background-color:#fff;border-radius:2px;overflow:hidden;width:100%;height:'+mini_size_height+'px;box-shadow:0 5px 40px rgba(0,0,0,.16)!important;-webkit-box-shadow:0 5px 40px rgba(0,0,0,.16)!important;">'+
									'<h6 class="pc-visitor-header" style="width:100%;box-sizing:border-box;background: '+minicolor_tbbj+' no-repeat 10px;margin:0;padding:0;padding-left: 42px;font-size: 14px;color: #fff;height: 36px;line-height: 36px;position: relative;font-weight: normal;padding-right: 72px;">'+
										'<img style="width:24px;height:24px;position:absolute;left:10px;top:6px;border-radius:2px;" src="http://www10.53kf.com/style/chat/new2017/image/png/logo.png"/>'+
	...
	//↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑  2017版访客端新增 ↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑
			...
			function max_min_company_mini(t)
			{
				if (t.getAttribute('max_min') == 'max')
				{
                    ...
                    $53("div_company_mini").style.right = '0px';
			     	$53("div_company_mini").style.bottom = '0px';                    $53("mini_header_bg_div").style.backgroundImage = "url('http://www10.53kf.com/style/chat/minichat2/img/header_bg2_1.png')";
				}
				else
				{
			...
			function hz6d_overTotalNum(type) {
				...
				// if(type == 'ivt') {
				// 	if(ivt_pop_total==1) {
				// 		var total_invite = $53.getCookie("invite_53kf_totalnum_2"+'ivt');
				// 		if(total_invite=="") { total_invite = 0; }
			...
			{
				if(zdfq_switch == 'yes') {
					//document.cookie = "onliner_zdfq70712085="+onliner_zdfq;
					document.cookie = "my_acc_reauto_time=" + new Date().getTime() + ";path=/";
				} else {
					document.cookie = "my_acc_reauto_time=null;path=/";
				}
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   //                  onliner_zdfq = 0;
			// 	}
   //              if(acc_autotype == 3) {onliner_zdfq = 3;document.cookie = "onliner_zdfq70712085="+onliner_zdfq;}
			...
			function ivt_seturl(zdy_yqk)
			{
				var divs_str = zdy_yqk.replace(/operating="([^"]*)"/g,function(str){
					...
					if(vals[1])
					{
						...
						{
							case 'KF':
								var click_open_url = 'window.open(\"http://www10.53kf.com/webCompany.php?arg=9005540&style=2&kflist=off&kf=&zdkf_type=1&lnk_overflow=0&language=cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fjxt.yuancheng05.com%2Fah%2F910b9430ebc9ea3c%2F&keyword=http%3A%2F%2Fjxt.yuancheng05.com%2F&brief=&logo=&question=&uid=a2e1d28c2761734a4d7cef761545fee0&tfrom=2\",\"_blank\",\"height=600,width=800,top=50,left=200,status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=no,location=no,titlebar=no\")';
								...
								break;
								//click_str ='onliner_zdfq=2;get_open_start();window.open(\"http://www10.53kf.com/webCompany.php?arg=9005540&style=2&kflist=off&kf=&zdkf_type=1&lnk_overflow=0&language=cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fjxt.yuancheng05.com%2Fah%2F910b9430ebc9ea3c%2F&keyword=http%3A%2F%2Fjxt.yuancheng05.com%2F&brief=&logo=&question=&uid=a2e1d28c2761734a4d7cef761545fee0&tfrom=2\",\"_blank\",\"height=473,width=703,top=200,left=200,status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=no,location=no,titlebar=no\");hidden_ivt();';break;
							case 'CLOSE':
								click_str = 'onliner_zdfq=3;jtfq_type=1;hidden_ivt();'; break;
							case 'ETEL':
								click_str = 'window.open(\'http://tb.53kf.com/eht.php?company_id=70712085&style_id=106180315\',\'_blank\',\'height=400,width=300,top=100,left=200,status=yes,toolbar=no,menubar=no,resizable=no,scrollbars=no,location=no,titlebar=no\')';break;
							case 'QQ':
								if(valst[1]){
